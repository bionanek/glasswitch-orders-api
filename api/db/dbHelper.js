...
Products.belongsToMany(Orders, {through: 'Products_Orders', foreignKey: 'Products_rowId'});
Orders.belongsToMany(Products, {through: 'Products_Orders', foreignKey: 'Orders_rowId'});
