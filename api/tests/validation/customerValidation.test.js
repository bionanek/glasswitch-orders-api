...
describe("Customers: ValidateCreate", () => {
	it("Should pass creation of a customer.", () => {
		...
		var bindCustomerCreate = CustomerValidation.ValidateCreate.bind(
			CustomerValidation,
			customerTestObject
		)
	...
	it("Should throw an error about missing field/s.", () => {
		...
		var bindCustomerCreate = CustomerValidation.ValidateUndefined.bind(
			CustomerValidation,
			customerTestObject
		)
		...
		expect(bindCustomerCreate)
			...
			.to.has.property(
				"message",
				"One or more request fields are missing. Missing field: 'name'."
			)
	})
	...
	it("Should throw an error about empty field/s.", () => {
		...
		var bindCustomerCreate = CustomerValidation.ValidateEmpty.bind(
			CustomerValidation,
			customerTestObject
		)
		...
		expect(bindCustomerCreate)
			...
			.to.has.property(
				"message",
				"One or more request fields are empty. Empty field: 'name'."
			)
	})
})
...
describe("Customers: ValidateIsNaN", () => {
	it("Should pass that given ID is a number.", () => {
		...
		var bindIdIsNaN = CustomerValidation.ValidateIdIsNaN.bind(
			CustomerValidation,
			customerId
		)
...
describe("Customers: ValidateIdExists", () => {
	it("Should pass that given ID exists.", () => {
		...
		var bindIdNotFound = Verification.IdExists.bind(
			CustomerValidation,
			customerId
		)
...
describe("Customers: ValidateUpdate", () => {
	it("Should pass the update.", () => {
		...
		var bindCustomerUpdate = CustomerValidation.ValidateUpdate.bind(
			CustomerValidation,
			customerTestObject
		)
