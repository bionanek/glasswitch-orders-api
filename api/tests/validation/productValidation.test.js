...
describe("Products: ValidateCreate", () => {
	it("Should pass creation of a product.", () => {
		...
		var bindProductCreate = ProductValidation.ValidateCreate.bind(
			ProductValidation,
			productTestObject
		)
	...
	it("Should throw an error about missing field/s.", () => {
		...
		var bindProductCreate = ProductValidation.ValidateAllFieldsUndefined.bind(
			ProductValidation,
			productTestObject
		)
	...
	it("Should throw an error about empty field/s.", () => {
		...
		var bindProductCreate = ProductValidation.ValidateAllFieldsEmpty.bind(
			ProductValidation,
			productTestObject
		)
...
describe("Products: ValidateIsNaN", () => {
	it("Should pass that given ID is a number.", () => {
		...
		var bindIdIsNaN = ProductValidation.ValidateIdIsNaN.bind(
			ProductValidation,
			productId
		)
...
describe("Products: ValidateIdExists", () => {
	it("Should pass that given ID exists.", () => {
		...
		var bindIdNotFound = Verification.IdExists.bind(Verification, productId)
...
describe("Products: ValidateSearchQuery", () => {
	it("Should throw error when query parameter has wrong name", () => {
		...
		const bindValidateSearchQuery = ProductValidation.ValidateSearchQuery.bind(
			ProductValidation,
			badSearchRequest
		)
	...
	it("Should pass validation with correct request query", () => {
		...
		expect(bindValidateSearchQuery).to.not.throw(RequestValidationError)
	})
})
...
describe("Products: ValidateUpdate", () => {
	it("Should pass the update.", () => {
		...
		var bindProductUpdate = ProductValidation.ValidateUpdate.bind(
			ProductValidation,
			productTestObject
		)
